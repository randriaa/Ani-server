...
const Conversation = () => {
    ...
    return (
        <Stack height={"100%"} maxHeight={"100vw"} width={"auto"}>
            ...
            {/* Msg */}
            <Box width={"100%"} sx={{ flexGrow: 1, backgroundColor: theme.palette.mode === "light" ? "#fff" : theme.palette.background.default }}>
            ...
            <Box
                ...
                <Stack direction={"row"} alignItems={"center"} spacing={3}>
                    <StyleInput fullWidth placeholder="..." variant="filled" InputProps={{
